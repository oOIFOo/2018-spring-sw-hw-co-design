...
HD_PWD='C:/Users/shlab_89/Desktop/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log face_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source face_wrapper.tcl
