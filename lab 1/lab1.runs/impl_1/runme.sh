...
HD_PWD='C:/Users/shlab_89/Desktop/lab1/lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log face_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source face_wrapper.tcl -notrace
