...
HD_PWD='C:/Users/shlab_81/Desktop/midterm/midterm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log midterm_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source midterm_wrapper.tcl
