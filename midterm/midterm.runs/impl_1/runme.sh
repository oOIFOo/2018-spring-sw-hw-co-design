...
HD_PWD='C:/Users/shlab_81/Desktop/midterm/midterm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log midterm_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source midterm_wrapper.tcl -notrace
