...
HD_PWD='C:/Users/Di/Desktop/codesign/midterm/mid/midterm_student/midterm.runs/midterm_matrix_multiplication_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log midterm_matrix_multiplication_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source midterm_matrix_multiplication_0_0.tcl
