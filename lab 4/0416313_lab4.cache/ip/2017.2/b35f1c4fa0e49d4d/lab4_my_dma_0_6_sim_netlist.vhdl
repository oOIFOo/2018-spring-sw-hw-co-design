...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_dma_v1_0_M00_AXI is
  ...
  signal \burst_length[5]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \total_length[8]_i_5_n_0\ : STD_LOGIC;
...
\burst_length[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \burst_length[0]_i_2_n_0\,
      I3 => \total_length[9]_i_3_n_0\,
      I4 => total_length(1),
      O => \burst_length[0]_i_1_n_0\
    );
\burst_length[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"888F8888"
    )
        port map (
...
\burst_length[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => burst_length(1),
      I1 => \burst_length[4]_i_2_n_0\,
      I2 => \burst_length[1]_i_2_n_0\,
      I3 => \total_length[9]_i_3_n_0\,
      I4 => total_length(1),
      I5 => \total_length[9]_i_4_n_0\,
      O => \burst_length[1]_i_1_n_0\
    );
\burst_length[1]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
\burst_length[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \burst_length[5]_i_3_n_0\,
      I4 => burst_length(2),
      I5 => \burst_length[4]_i_2_n_0\,
...
\burst_length[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => burst_length(4),
      I4 => \total_length[3]_i_2_n_0\,
      I5 => \burst_length[4]_i_3_n_0\,
      O => \burst_length[4]_i_1_n_0\
    );
\burst_length[4]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FD"
    )
        port map (
...
\burst_length[4]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000002"
    )
        port map (
...
\burst_length[5]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\burst_length[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => flag_reg_n_0,
      I3 => \total_length[9]_i_3_n_0\,
      I4 => \burst_length[5]_i_3_n_0\,
      I5 => burst_length(5),
      O => \burst_length[5]_i_2_n_0\
    );
\burst_length[5]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\total_length[8]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"4444444444F44444"
        ...
        port map (
      I0 => \total_length[8]_i_4_n_0\,
      I1 => \slv_reg3_reg[11]\(8),
      I2 => \total_length[9]_i_4_n_0\,
      I3 => total_length(8),
      I4 => total_length(9),
      I5 => \total_length[8]_i_5_n_0\,
...
\total_length[8]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\total_length[9]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFA8"
    )
        port map (
...
init_txn_ff_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
init_txn_ff_i_6: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => slv_reg0(1),
      I2 => slv_reg0(2),
      I3 => init_txn_ff_i_7_n_0,
      O => init_txn_ff_i_6_n_0
    );
init_txn_ff_i_7: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
