...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_dma_v1_0_M00_AXI is
  ...
  signal writes_done_reg_i_7_n_0 : STD_LOGIC;
  signal writes_done_reg_i_7_n_1 : STD_LOGIC;
  signal writes_done_reg_i_7_n_2 : STD_LOGIC;
  signal writes_done_reg_i_7_n_3 : STD_LOGIC;
  ...
  signal NLW_writes_done_reg_i_7_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of axi_wlast_i_3 : label is "soft_lutpair2";
...
read_index1_carry_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
writes_done_reg_i_2: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2) => writes_done_i_4_n_0,
      S(1) => writes_done_i_5_n_0,
      S(0) => writes_done_i_6_n_0
    );
...
writes_done_reg_i_7: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => writes_done_reg_i_7_n_0,
      CO(2) => writes_done_reg_i_7_n_1,
      CO(1) => writes_done_reg_i_7_n_2,
      CO(0) => writes_done_reg_i_7_n_3,
      CYINIT => '1',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => NLW_writes_done_reg_i_7_O_UNCONNECTED(3 downto 0),
      S(3) => writes_done_i_12_n_0,
      S(2) => writes_done_i_13_n_0,
      S(1) => writes_done_i_14_n_0,
      S(0) => writes_done_i_15_n_0
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
