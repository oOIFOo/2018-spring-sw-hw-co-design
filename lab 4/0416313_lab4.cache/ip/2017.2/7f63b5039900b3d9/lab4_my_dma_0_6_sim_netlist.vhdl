...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_dma_v1_0_M00_AXI is
  ...
  signal \burst_length[2]_i_5_n_0\ : STD_LOGIC;
  signal \burst_length[2]_i_6_n_0\ : STD_LOGIC;
  ...
  signal \^m00_axi_arlen\ : STD_LOGIC_VECTOR ( 6 downto 0 );
...
\burst_length[2]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\burst_length[2]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0020"
    )
        port map (
...
\burst_length[2]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\burst_length[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0C0C4C0C"
    )
        port map (
...
reads_done_i_14: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000660"
    )
        port map (
...
\total_length[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\total_length[6]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\total_length[6]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\total_length[7]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
\total_length[9]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000002"
    )
        port map (
...
\total_length[9]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\total_length[9]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
writes_done_i_16: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000660"
    )
        port map (
