...
HD_PWD='D:/0416313_lab4/0416313_lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab4_wrapper.tcl -notrace
