  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  total = end - start;
  float dmips_per_mhz = ((float)Number_Of_Runs/1757 * (XPAR_CPU_CORTEXA9_CORE_CLOCK_FREQ_HZ/100))/(float)(total * 1000000);
  ...
  printf ("\n");
  printf("DMIPS/Mhz      : %f/100\n", (float)(dmips_per_mhz * 100));
  printf("Proc Frequency : %d Hz\n", XPAR_CPU_CORTEXA9_CORE_CLOCK_FREQ_HZ);
  printf("DMIPS          : %f\n", (float)(dmips_per_mhz * XPAR_CPU_CORTEXA9_CORE_CLOCK_FREQ_HZ/1000000));
